...
export const PIPELINE = [
  ...
  },
  {
    ...
    agente: "fiscal",
    core: "[PLACEHOLDER MVP] Confirme ao vivo os endpoints que o DAG listou: params, shapes reais, limites.",
  ...
  },
  {
    ...
    core: "[PLACEHOLDER MVP] Confronte o que existe com o que a feature precisa. Liste gaps, no-gos, complexidade.",
  ...
  },
  {
    ...
    core: "[PLACEHOLDER MVP] Defina estados, comportamento, critérios de aceitação (Three Amigos) e riscos (Pre-mortem).",
  ...
  },
  {
    ...
    agente: "Plan",
    core: "[PLACEHOLDER MVP] Organize unidades de implementação, paralelismo e decida Walking Skeleton.",
  ...
  },
  {
    ...
    core: "[PLACEHOLDER MVP] Implemente conforme o mapa, com endpoints confirmados e no-gos respeitados.",
  ...
  },
  {
    ...
    core: "[PLACEHOLDER MVP] Revisão adversarial do diff com lentes por arquétipo. Veredito APROVA/REPROVA.",
    schema: ["veredito"],
  ...
  },
  {
    ...
    agente: "fiscal",
    core: "[PLACEHOLDER MVP] Execute os cenários com dado real. Veredito verificado/diverge/inconclusivo.",
