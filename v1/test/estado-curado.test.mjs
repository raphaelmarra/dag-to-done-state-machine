...
describe("Peça 7 — estado curado por etapa", () => {
  ...
  it("uma etapa SEM estadoCurado declarado usa o default (não regride)", () => {
    // 'aprovacao_humana' (etapa 10) ainda é placeholder; o motor usa o default. (1-9 destiladas.)
    const g = etapaPorId("aprovacao_humana");
    assert.ok(!g.estadoCurado, "acessibilidade não declara estadoCurado (usa default)");
